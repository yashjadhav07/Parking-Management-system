...
const LoginForm = ({ validated, signInHandler, inputChangeHandler, user: { u_email, u_password }, loginError, errorMessage }) => {
    return (
        <Form noValidate validated={validated} onSubmit={signInHandler}>
            ...
            <Button variant="outline-secondary" type="submit" href="/register" className="ml-2">
                Register
            </Button>
        </Form>
    );
        ...
        return (
            <div>
                <Container>
                    <Row style={{ margin: 50 }}>
                        <Col></Col>
                        <Col xs="12" md="6"><LoginForm validated={this.state.validated} user={this.state.userDetail} loginError={this.state.loginError} errorMessage={this.state.errorMessage} inputChangeHandler={this.inputChangeHandler.bind(this)} signInHandler={this.signInHandler.bind(this)}></LoginForm></Col>
                        <Col></Col>
                    </Row>
                </Container>
            </div>
